...
$navigation_active = ( 'nav-left-sidebar' == aravan_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php aravan_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * aravan_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'aravan_before_left_sidebar_content' );
		...
		/**
		 * aravan_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'aravan_after_left_sidebar_content' );
		?>
