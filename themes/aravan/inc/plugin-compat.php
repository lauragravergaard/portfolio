...
add_action( 'after_setup_theme', 'aravan_setup_woocommerce' );
/**
 * Set up WooCommerce
 *
 */
function aravan_setup_woocommerce() {
	...
	add_action( 'woocommerce_sidebar', 'aravan_construct_sidebars' );
}

if ( ! function_exists( 'aravan_woocommerce_start' ) ) {
	add_action( 'woocommerce_before_main_content', 'aravan_woocommerce_start', 10 );
	/**
	 * Add WooCommerce starting wrappers
	 *
	 */
	function aravan_woocommerce_start() { ?>
...
if ( ! function_exists( 'aravan_woocommerce_end' ) ) {
	add_action( 'woocommerce_after_main_content', 'aravan_woocommerce_end', 10 );
	/**
	 * Add WooCommerce ending wrappers
	 *
	 */
	function aravan_woocommerce_end() { ?>
						</div><!-- .entry-content -->
						<?php
						/**
...
if ( ! function_exists( 'aravan_woocommerce_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'aravan_woocommerce_css', 100 );
	/**
	 * Add WooCommerce CSS
	 *
	 */
	function aravan_woocommerce_css() {
		if ( ! class_exists( 'WooCommerce' ) ) {
			return;
		}

		$mobile = apply_filters( 'aravan_mobile_media_query', '(max-width:768px)' );
...
if ( ! function_exists( 'aravan_bbpress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'aravan_bbpress_css', 100 );
	/**
	 * Add bbPress CSS
	 *
	 */
	function aravan_bbpress_css() {
...
if ( ! function_exists( 'aravan_buddypress_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'aravan_buddypress_css', 100 );
	/**
	 * Add BuddyPress CSS
	 *
	 */
	function aravan_buddypress_css() {
...
if ( ! function_exists( 'aravan_beaver_builder_css' ) ) {
	add_action( 'wp_enqueue_scripts', 'aravan_beaver_builder_css', 100 );
	/**
	 ...
	 *
	 */
	function aravan_beaver_builder_css() {
