...
wp_head() 
?>
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_theme_file_uri('faveicon-32x32.png'); ?>">
</head>
...
<section id="aboutme" class="section descripton">
  <div class="container">
    ...
    <div class="col-md-10 col-md-offset-1 space">
      <?php
        if(is_active_sidebar( 'about-me-2' )) {
            dynamic_sidebar( 'about-me-2' );
        }
      ?>
    </div>
  </div>
...
<!-- JS FILES --> 
<?php
    // Inserts all important footer-files (typical js-files) from WordPress inclusive functions.php
    wp_footer();
?>
</body>
</html>